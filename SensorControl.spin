...
CON
        ...
        tof1SCL = 2, tof1SDA = 3, tof1RST = 15                                  'Front ToF Pins
        tof2SCL = 0, tof2SDA = 1, tof2RST = 14                                  'Rear ToF Pins
...
OBJ
  Ultra         : "EE-7_Ultra.spin"                                             'HC-SR04
  ToFDriver     : "EE-7_ToF_edited.spin"                                        'VL6180X
...
PUB Start(F_UltPtr, R_UltPtr, F_ToFPtr, R_ToFPtr, RDYPtr)                       'Looping Code for sensor updates
  ...
  repeat                                                                        'Update sensor values to cog 0
    ...
    LONG[F_ToFPtr] := ReadToF(Front)
    LONG[R_UltPtr] := ReadUltraSonic(Rear)
    LONG[R_ToFPtr] := ReadToF(Rear)
